...
function PlacesToVisit({ trip }) {
  return (
    <div>
      <h2 className='font-sans text-xl md:text-2xl font-light md:font-medium mt-8 mb-0'>🌍 Must-See Spots : Because some views are worth the miles...</h2>

      <div>
        {trip?.TripData?.itinerary.map((item, idx) => (
          <div key={idx} className='mt-2 p-2'>
            <div className="mt-5 w-full border-t border-gray-400 py-4">
